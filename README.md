...
## Как запустить
1. Скачайте [Python](https://www.python.org/downloads/) 3.7+
2. Скачайте [WarThunder RPC v1.0.0](https://github.com/MoTyaZ1/WarTunder-DiscordRichPresence/releases/tag/v1.0.0)
3. Скачайте [settings.json](https://github.com/MoTyaZ1/WarTunder-DiscordRichPresence/releases/tag/v1.0.0)
4. запустите WarThunderDiscordRPC.exe
5. (не обязательно) откройте любым редактором settings.json для настройки консольной программы
## Ответы
Это моя первая программа 

Портировать проект на linux, macos не буду

Протестированно было на Windows 11 Pro - 25H2 26220.7523
